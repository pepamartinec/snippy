...
<body id="infoScreen">
	<!-- SCREEN CONTENT -->
	<div id="exception">
		<h1><?php echo get_class( $this->exception ) ?></h1>
		<p><?php echo $this->exception->getMessage() ?></p>
	</div>

	<div id="source">
		<?php echo $this->formater->formatSourceCode( $this->exception->getFile(), $this->exception->getLine() ) ?>
	</div>
	...
	<fieldset>
		...
		<div id="stackTrace">
			<?php echo $this->formater->formatTrace( $this->exception->getTrace() ) ?>
		</div>
	</fieldset>
